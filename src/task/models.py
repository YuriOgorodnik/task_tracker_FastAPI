...
task = Table(
    ...
    Column("created_at", TIMESTAMP(timezone=True), default=datetime.utcnow, doc="Дата и время создания задачи"),
    Column("deadline", TIMESTAMP(timezone=True), nullable=False, doc="Конечная дата и время исполнения задачи"),
